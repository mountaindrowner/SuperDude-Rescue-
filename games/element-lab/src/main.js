...
DANNYLAB.sceneClasses = function () {
  return [
    ...
    DANNYLAB.CollectionScene, DANNYLAB.LoadingScene, DANNYLAB.CardDemoScene,
  ];
};
...
DANNYLAB.exitSubgame = function (scene) {
  ...
  var keys = ['DANNYLAB_Pause', 'DANNYLAB_Options', 'DANNYLAB_Confirm', 'DANNYLAB_GameOver',
    'DANNYLAB_HowTo', 'DANNYLAB_Discovery', 'DANNYLAB_Collection', 'DANNYLAB_Loading', 'DANNYLAB_CardDemo', 'DANNYLAB_Game', 'DANNYLAB_Menu'];
