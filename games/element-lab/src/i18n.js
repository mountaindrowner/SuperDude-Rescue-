...
DANNYLAB.STRINGS = {
  en: {
    ...
    // mystery effect explanations — {n} is the real count of pieces affected
    myst_updraft: 'Whoosh! {n} Hydrogen popped!',
    myst_float: '{n} small pieces floated away!',
    myst_crystal: '{n} pieces grew a tier!',
    myst_combust: 'The blast cleared {n} small pieces!',
    myst_glow: '{n} pieces powered up! Next merges score BIG!',
    myst_fizz: '{n} small pieces fizzed away!',
    myst_magnet: 'Everything pulled together - merge time!',
    myst_midas: '{n} pieces turned to gold dust! +300',
    myst_fission: 'The blast vaporized {n} pieces!',
    myst_surge: 'Energy surge! A piece grew a tier!',
    ...
    // what each daily modifier actually DOES (menu + run-start banner)
    daily_desc_lowgrav: 'Half gravity - drops float down slow!',
    daily_desc_heavy: 'Heavy matter - everything falls FAST!',
    daily_desc_bouncy: 'Extra bouncy - elements bounce like crazy!',
    daily_desc_mystery: 'Mystery Samples every 15 drops!',
    daily_desc_tiny: 'Tiny lab - the fill line is LOWER!',
    daily_desc_jumbo: 'Jumbo drops - bigger pieces fall today!',
  ...
  es: {
    ...
    myst_updraft: '¡Fiuu! ¡{n} Hidrógenos explotaron!',
    myst_float: '¡{n} piezas pequeñas se fueron flotando!',
    myst_crystal: '¡{n} piezas subieron de nivel!',
    myst_combust: '¡La explosión limpió {n} piezas pequeñas!',
    myst_glow: '¡{n} piezas mejoradas! ¡Las próximas fusiones dan MÁS!',
    myst_fizz: '¡{n} piezas pequeñas burbujearon y desaparecieron!',
    myst_magnet: '¡Todo se junta - hora de fusionar!',
    myst_midas: '¡{n} piezas se volvieron polvo de oro! +300',
    myst_fission: '¡La explosión vaporizó {n} piezas!',
    myst_surge: '¡Oleada de energía! ¡Una pieza subió de nivel!',
    ...
    daily_desc_lowgrav: '¡Media gravedad - las piezas caen flotando!',
    daily_desc_heavy: '¡Materia pesada - todo cae RÁPIDO!',
    daily_desc_bouncy: '¡Súper rebote - los elementos rebotan sin parar!',
    daily_desc_mystery: '¡Muestras Misteriosas cada 15 caídas!',
    daily_desc_tiny: '¡Lab diminuto - la línea de llenado está más BAJA!',
    daily_desc_jumbo: '¡Caídas jumbo - hoy caen piezas más grandes!',
...
DANNYLAB.FACTS = [
  ...
  { en: 'Salt is a fiery metal joined to a sharp green gas, two wild things God combined just to flavor your food.',
    es: 'La sal es un metal ardiente unido a un gas verde intenso, dos cosas salvajes que Dios combinó solo para dar sabor a tu comida.' },
  { en: 'The DNA coiled inside one tiny cell would stretch taller than a grown-up, a secret code God wrote to spell out you.',
    es: 'El ADN enrollado en una sola célula diminuta se estiraría más alto que un adulto, un código secreto que Dios escribió para formarte.' },
