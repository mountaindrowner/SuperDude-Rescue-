...
DANNYLAB.STRINGS = {
  en: {
    ...
    toast_bigcascade: 'SCIENCE OVERLOAD!!',
  ...
  es: {
    ...
    toast_bigcascade: '¡¡SOBRECARGA DE CIENCIA!!',
...
DANNYLAB.ELEMENTS = {
  H:  { en: 'Hydrogen', es: 'Hidrógeno',
        fact_en: 'The lightest element in the universe — stars are made mostly of it!',
        fact_es: '¡El elemento más ligero del universo — las estrellas están hechas casi todas de él!' },
  He: { en: 'Helium', es: 'Helio',
        fact_en: "Lighter than air — it's what makes balloons float!",
        fact_es: '¡Más ligero que el aire — por eso flotan los globos!' },
  C:  { en: 'Carbon', es: 'Carbono',
        fact_en: "It's in pencils AND diamonds — same element, different shapes!",
        fact_es: '¡Está en los lápices Y en los diamantes — el mismo elemento, distintas formas!' },
  ...
  U:  { en: 'Uranium', es: 'Uranio',
        fact_en: 'One of the heaviest natural elements — its atoms can split and release huge energy!',
        fact_es: '¡Uno de los elementos naturales más pesados — sus átomos pueden dividirse y liberar muchísima energía!' },
};
